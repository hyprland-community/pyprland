...
<PluginCommands plugin="toggle_special"  version="3.3.1" />

## Configuration

<PluginConfig plugin="toggle_special" linkPrefix="config-"  version="3.3.1" />

### `name` <ConfigBadges plugin="toggle_special" option="name"  version="3.3.1" /> {#config-name}
