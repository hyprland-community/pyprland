...
<PluginCommands plugin="menubar"  version="3.3.1" />

## Configuration

<PluginConfig plugin="menubar" linkPrefix="config-"  version="3.3.1" />

### `command` <ConfigBadges plugin="menubar" option="command"  version="3.3.1" /> {#config-command}
