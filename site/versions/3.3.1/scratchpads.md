...
<PluginCommands plugin="scratchpads"  version="3.3.1" />
...
<PluginConfig plugin="scratchpads" linkPrefix="config-" :filter="['command', 'class', 'animation', 'size', 'position', 'margin', 'max_size', 'multi', 'lazy']"  version="3.3.1" />
...
### `command` <ConfigBadges plugin="scratchpads" option="command"  version="3.3.1" /> {#config-command}

This is the command you wish to run in the scratchpad. It supports [variables](./Variables).

### `class` <ConfigBadges plugin="scratchpads" option="class"  version="3.3.1" /> {#config-class}
...
### `animation` <ConfigBadges plugin="scratchpads" option="animation"  version="3.3.1" /> {#config-animation}
...
### `size` <ConfigBadges plugin="scratchpads" option="size"  version="3.3.1" /> {#config-size}
...
### `position` <ConfigBadges plugin="scratchpads" option="position"  version="3.3.1" /> {#config-position}
...
### `margin` <ConfigBadges plugin="scratchpads" option="margin"  version="3.3.1" /> {#config-margin}

Pixels from the screen edge when using animations. Used to position the window along the animation axis.

### `max_size` <ConfigBadges plugin="scratchpads" option="max_size"  version="3.3.1" /> {#config-max-size}

Maximum window size. Same format as `size`. Useful to prevent scratchpads from growing too large on big monitors.

### `multi` <ConfigBadges plugin="scratchpads" option="multi"  version="3.3.1" /> {#config-multi}
...
### `lazy` <ConfigBadges plugin="scratchpads" option="lazy"  version="3.3.1" /> {#config-lazy}
