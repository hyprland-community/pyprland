...
<PluginConfig plugin="wallpapers" linkPrefix="config-" :filter="['online_ratio', 'online_backends', 'online_keywords', 'online_folder']"  version="3.3.1" />

### `online_ratio` <ConfigBadges plugin="wallpapers" option="online_ratio"  version="3.3.1" /> {#config-online-ratio}
...
### `online_backends` <ConfigBadges plugin="wallpapers" option="online_backends"  version="3.3.1" /> {#config-online-backends}
...
### `online_keywords` <ConfigBadges plugin="wallpapers" option="online_keywords"  version="3.3.1" /> {#config-online-keywords}
...
### `online_folder` <ConfigBadges plugin="wallpapers" option="online_folder"  version="3.3.1" /> {#config-online-folder}
...
<PluginConfig plugin="wallpapers" linkPrefix="config-" :filter="['cache_days', 'cache_max_mb', 'cache_max_images']"  version="3.3.1" />

### `cache_days` <ConfigBadges plugin="wallpapers" option="cache_days"  version="3.3.1" /> {#config-cache-days}
...
### `cache_max_mb` <ConfigBadges plugin="wallpapers" option="cache_max_mb"  version="3.3.1" /> {#config-cache-max-mb}
...
### `cache_max_images` <ConfigBadges plugin="wallpapers" option="cache_max_images"  version="3.3.1" /> {#config-cache-max-images}
