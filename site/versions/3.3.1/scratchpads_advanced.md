...
<PluginConfig plugin="scratchpads" linkPrefix="config-" :filter="['use', 'pinned', 'excludes', 'restore_excluded', 'unfocus', 'hysteresis', 'preserve_aspect', 'offset', 'hide_delay', 'force_monitor', 'alt_toggle', 'allow_special_workspaces', 'smart_focus', 'close_on_hide', 'monitor']"  version="3.3.1" />

### `use` <ConfigBadges plugin="scratchpads" option="use"  version="3.3.1" /> {#config-use}
...
### `pinned` <ConfigBadges plugin="scratchpads" option="pinned"  version="3.3.1" /> {#config-pinned}

Makes the scratchpad "sticky" to the monitor, following any workspace change.

### `excludes` <ConfigBadges plugin="scratchpads" option="excludes"  version="3.3.1" /> {#config-excludes}
...
### `restore_excluded` <ConfigBadges plugin="scratchpads" option="restore_excluded"  version="3.3.1" /> {#config-restore-excluded}
...
### `unfocus` <ConfigBadges plugin="scratchpads" option="unfocus"  version="3.3.1" /> {#config-unfocus}

When set to `"hide"`, allow to hide the window when the focus is lost.

Use `hysteresis` to change the reactivity

### `hysteresis` <ConfigBadges plugin="scratchpads" option="hysteresis"  version="3.3.1" /> {#config-hysteresis}
...
### `preserve_aspect` <ConfigBadges plugin="scratchpads" option="preserve_aspect"  version="3.3.1" /> {#config-preserve-aspect}
...
### `offset` <ConfigBadges plugin="scratchpads" option="offset"  version="3.3.1" /> {#config-offset}
...
### `hide_delay` <ConfigBadges plugin="scratchpads" option="hide_delay"  version="3.3.1" /> {#config-hide-delay}
...
### `force_monitor` <ConfigBadges plugin="scratchpads" option="force_monitor"  version="3.3.1" /> {#config-force-monitor}

If set to some monitor name (eg: `"DP-1"`), it will always use this monitor to show the scratchpad.

### `alt_toggle` <ConfigBadges plugin="scratchpads" option="alt_toggle"  version="3.3.1" /> {#config-alt-toggle}
...
### `allow_special_workspaces` <ConfigBadges plugin="scratchpads" option="allow_special_workspaces"  version="3.3.1" /> {#config-allow-special-workspaces}
...
### `smart_focus` <ConfigBadges plugin="scratchpads" option="smart_focus"  version="3.3.1" /> {#config-smart-focus}
...
### `close_on_hide` <ConfigBadges plugin="scratchpads" option="close_on_hide"  version="3.3.1" /> {#config-close-on-hide}
...
### `monitor` <ConfigBadges plugin="scratchpads" option="monitor"  version="3.3.1" /> {#config-monitor}
