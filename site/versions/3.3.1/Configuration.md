...
<PluginConfig plugin="pyprland" linkPrefix="config-"  version="3.3.1" />

### `include` <ConfigBadges plugin="pyprland" option="include"  version="3.3.1" /> {#config-include}
...
### `notification_type` <ConfigBadges plugin="pyprland" option="notification_type"  version="3.3.1" /> {#config-notification-type}
...
### `variables` <ConfigBadges plugin="pyprland" option="variables"  version="3.3.1" /> {#config-variables}
