...
<PluginCommands plugin="layout_center"  version="3.3.1" />

## Configuration

<PluginConfig plugin="layout_center" linkPrefix="config-"  version="3.3.1" />

### `style` <ConfigBadges plugin="layout_center" option="style"  version="3.3.1" /> {#config-style}
...
### `on_new_client` <ConfigBadges plugin="layout_center" option="on_new_client"  version="3.3.1" /> {#config-on-new-client}
...
### `next` / `prev` <ConfigBadges plugin="layout_center" option="next"  version="3.3.1" /> {#config-next}
...
### `next2` / `prev2` <ConfigBadges plugin="layout_center" option="next2"  version="3.3.1" /> {#config-next2}
...
### `offset` <ConfigBadges plugin="layout_center" option="offset"  version="3.3.1" /> {#config-offset}
...
### `margin` <ConfigBadges plugin="layout_center" option="margin"  version="3.3.1" /> {#config-margin}
