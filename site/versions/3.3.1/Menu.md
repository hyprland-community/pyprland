...
<PluginConfig plugin="menu" linkPrefix="config-"  version="3.3.1" />

### `engine` <ConfigBadges plugin="menu" option="engine"  version="3.3.1" /> {#config-engine}
...
### `parameters` <ConfigBadges plugin="menu" option="parameters"  version="3.3.1" /> {#config-parameters}
