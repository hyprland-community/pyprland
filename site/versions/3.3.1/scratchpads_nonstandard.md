...
<PluginConfig plugin="scratchpads" linkPrefix="config-" :filter="['match_by', 'initialClass', 'initialTitle', 'title', 'process_tracking', 'skip_windowrules']"  version="3.3.1" />

### `match_by` <ConfigBadges plugin="scratchpads" option="match_by"  version="3.3.1" /> {#config-match-by}
...
### `process_tracking` <ConfigBadges plugin="scratchpads" option="process_tracking"  version="3.3.1" /> {#config-process-tracking}
...
### `skip_windowrules` <ConfigBadges plugin="scratchpads" option="skip_windowrules"  version="3.3.1" /> {#config-skip-windowrules}
