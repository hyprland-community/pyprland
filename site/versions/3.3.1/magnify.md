...
<PluginCommands plugin="magnify"  version="3.3.1" />
...
<PluginConfig plugin="magnify" linkPrefix="config-"  version="3.3.1" />

### `factor` <ConfigBadges plugin="magnify" option="factor"  version="3.3.1" /> {#config-factor}

The zoom level to use when `pypr zoom` is called without arguments.

### `duration` <ConfigBadges plugin="magnify" option="duration"  version="3.3.1" /> {#config-duration}
