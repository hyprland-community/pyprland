...
<PluginCommands plugin="wallpapers"  version="3.3.1" />
...
<PluginConfig plugin="wallpapers" linkPrefix="config-" :filter="['path', 'interval', 'command', 'clear_command', 'post_command', 'radius', 'extensions', 'recurse', 'unique']"  version="3.3.1" />

### `path` <ConfigBadges plugin="wallpapers" option="path"  version="3.3.1" /> {#config-path}
...
### `interval` <ConfigBadges plugin="wallpapers" option="interval"  version="3.3.1" /> {#config-interval}

How long (in minutes) a background should stay in place before changing.

### `command` <ConfigBadges plugin="wallpapers" option="command"  version="3.3.1" /> {#config-command}
...
### `clear_command` <ConfigBadges plugin="wallpapers" option="clear_command"  version="3.3.1" /> {#config-clear-command}
...
### `post_command` <ConfigBadges plugin="wallpapers" option="post_command"  version="3.3.1" /> {#config-post-command}
...
### `radius` <ConfigBadges plugin="wallpapers" option="radius"  version="3.3.1" /> {#config-radius}
...
### `extensions` <ConfigBadges plugin="wallpapers" option="extensions"  version="3.3.1" /> {#config-extensions}

List of valid wallpaper image extensions.

### `recurse` <ConfigBadges plugin="wallpapers" option="recurse"  version="3.3.1" /> {#config-recurse}

When enabled, will also search sub-directories recursively.

### `unique` <ConfigBadges plugin="wallpapers" option="unique"  version="3.3.1" /> {#config-unique}
